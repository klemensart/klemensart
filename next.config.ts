...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: "/saman-sembolleri", destination: "/icerikler/yazi/turk-sanatinda-islamiyet-sonrasi-buyuk-degisim-bilinmeyenler", permanent: true },
      { source: "/icerikler/yazi/saman-sembolleri", destination: "/icerikler/yazi/turk-sanatinda-islamiyet-sonrasi-buyuk-degisim-bilinmeyenler", permanent: true },
