...
export default function NewsletterFormAeon({
      ...
      >
        <div className="flex flex-col items-center text-center gap-3">
          <div
            ...
            style={{ backgroundColor: "rgba(255,109,96,0.12)" }}
          >
          ...
          <div>
            ...
            <p className="text-sm leading-relaxed max-w-sm mx-auto" style={{ color: "#8C857E" }}>
  ...
  return (
    ...
    >
      {/* Heading */}
      <h3
        className="font-semibold text-warm-900 leading-tight"
        style={{ fontFamily: "var(--font-newsreader), Georgia, serif", fontSize: 24, marginBottom: 6 }}
      >
        Kültür-Sanat Pusulası
      </h3>
      <p className="text-sm leading-normal" style={{ color: "#8C857E", marginBottom: 20 }}>
        1.500+ okurla her pazar. Ayda 4 e-mail.
      </p>

      <form onSubmit={handleSubmit}>
        {/* Email + button — horizontal on sm+ */}
        <div className="flex flex-col sm:flex-row gap-3">
          ...
          <button
            type="submit"
            disabled={isSubmitting}
            className="h-11 px-6 bg-coral text-white rounded-full text-sm font-medium hover:bg-coral/90 transition-colors whitespace-nowrap disabled:opacity-50 disabled:cursor-not-allowed"
          >
        ...
        <div className="mt-4 flex justify-end text-xs" style={{ color: "#8C857E" }}>
