...
export default function Muzede1SaatTesekkur({
  name = "Sanat Sever",
}: Props) {
  return (
    <KlemensLayout preview="Müzede 1 Saat rehberiniz hazır — hemen indirin!">
      <Section style={content}>
        <Text style={heading}>Müzede 1 Saat Rehberiniz Hazır!</Text>

        <Text style={paragraph}>
          Merhaba {name}, İstanbul Arkeoloji Müzesi rehberinizi aşağıdaki
          bağlantıdan hemen indirebilirsiniz.
        </Text>

        <div style={infoBox}>
          <Text style={infoTitle}>Rehberde Neler Var</Text>
          <Text style={infoItem}>1 saatlik optimize edilmiş müze rotası</Text>
