...
async function fetchNextSessionDate(workshopId: string): Promise<string | null> {
  try {
    ...
    if (!raw.includes("T")) return `${raw}T20:30:00+03:00`;
    // Has time but no offset → treat as Turkey time
    return `${raw}+03:00`;
  } catch {
    return null;
  }
...
export async function generateMetadata({ params }: Props) {
  ...
  const meta: Record<string, { title: string; description: string }> = {
    ...
    "ronesans-okuryazarligi-2": {
      title: "Rönesans Okur-Yazarlığı",
      description: "1 Haziran Pazartesi başlıyor! 8 haftada Floransa, Roma, Venedik ve Milano'nun ustalarını öğrenin. 6 ay kayıt erişimi ve PDF çalışma dokümanları dahil.",
    },
...
export default async function AtolyeDetayPage({ params }: Props) {
  ...
  const courseDescriptions: Record<string, string> = {
    ...
    "ronesans-okuryazarligi-2": "1 Haziran Pazartesi başlıyor! 8 haftada Rönesans'ın ustalarını öğrenin. 6 ay kayıt erişimi ve PDF dokümanlar dahil.",
...
function Ronesans2Page({
  ...
  const program = [
    { tarih: "1 Haziran 2026 Pzt",   konu: "Floransa I — Duomo, Baptistery ve Erken Rönesans'ın Doğuşu" },
    { tarih: "8 Haziran 2026 Pzt",   konu: "Floransa II — Botticelli, Michelangelo ve Medici Çevresi" },
    { tarih: "15 Haziran 2026 Pzt",  konu: "Roma I — Vatikan, Sistine Şapeli ve Yüksek Rönesans" },
    { tarih: "22 Haziran 2026 Pzt",  konu: "Roma II — Raphael ve Rönesans Mimarisinin Grameri" },
    { tarih: "29 Haziran 2026 Pzt",  konu: "Venedik I — Titian, Tintoretto ve Renk Felsefesi" },
    { tarih: "6 Temmuz 2026 Pzt",   konu: "Venedik II — Mimari, Su ve Osmanlı Bağlantısı" },
    { tarih: "13 Temmuz 2026 Pzt",  konu: "Milano & Leonardo — Sfumato, Bilim ve Sanatın Birleşimi" },
    { tarih: "20 Temmuz 2026 Pzt",  konu: "Büyük Final — 3 Adımda Eser Okuma ve Müze Stratejisi" },
  ];
    ...
    <>
      ...
      <main style={{ background: B.cream, minHeight: "100vh" }}>
        ...
        <ProminentDateBlock
          ...
          gun="Pazartesi"
          saat="20:30 – 22:00"
          ekstra="8 Hafta · Online (Zoom) · 1 Haziran – 20 Temmuz 2026"
        />
        ...
        <div style={{ maxWidth: 800, margin: "0 auto", padding: "0 24px" }}>
          ...
          <BilgiBanner>
            ...
            <p style={{ margin: "0 0 4px" }}>
              Pazartesi 20:30–22:00 · 1 Haziran – 20 Temmuz 2026
            </p>
          ...
          <section style={{ paddingBottom: 56 }}>
            ...
            <p style={{ color: B.warm, fontSize: 13, margin: "0 0 24px" }}>
              Her Pazartesi 20:30 · Zoom · 1 Haziran – 20 Temmuz 2026
            </p>
