...
export const SLUG_TO_ATOLYE: Record<string, AtolyeConfig> = {
  "sanat-tarihinde-duygular": {
    ...
    price: 150000,
    forSale: true,
    imgCover: "/images/workshops/sanat-tarihinde-duygular-cover.png",
  ...
  "modern-sanat-atolyesi": {
    ...
    price: 600000,
    forSale: true,
    imgCover: "/images/workshops/modern-sanat-atolyesi-cover.png",
  ...
  "ronesans-okuryazarligi": {
    ...
    price: 0,
    forSale: false,
    imgCover: "/images/workshops/ronesans-atolyesi-cover.png",
