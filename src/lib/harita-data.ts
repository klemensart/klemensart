...
export const PLACES: CulturePlace[] = [
  ...
  { lat: 39.9430, lng: 32.8540, type: "müze", name: "I. TBMM Binası (Kurtuluş Savaşı Müzesi)", desc: "23 Nisan 1920'de açılan Meclis, Milli Mücadele'nin yönetildiği bina.", era: ["osmanli", "cumhuriyet"], longDesc: "1915'te İttihat ve Terakki kulüp binası olarak Evkaf Mimarı Salim Bey tarafından projelendirilen yapının inşası yarım kalmış, Milli Mücadele'nin merkezi olması kararlaştırılınca askeri mimar Hasip Bey gözetiminde Ankaralıların katkılarıyla tamamlanmıştır. \"Ankara Taşı\" olarak bilinen andezit taşından inşa edilen bina, 23 Nisan 1920'de TBMM olarak kapılarını açmıştır.\n\n1921 Anayasası'nın kabulü, İstiklal Marşı'nın onaylanması, Saltanatın kaldırılması, Ankara'nın başkent oluşu ve 29 Ekim 1923'te Cumhuriyet'in ilanı bu çatı altında gerçekleşmiştir. 1961'de müzeye dönüştürülen yapıda orijinal Riyaset Divanı, dönemin ahşap sıraları, meclis tutanakları ve Milli Mücadele'ye ait şifreli telgraf cihazları sergilenmektedir.", funFacts: ["Çatı için kiremit yetmeyince Ankaralılar kendi evlerinin çatılarından söktükleri kiremitleri kucaklarında taşıyarak meclisin çatısını tamamladı.", "Milletvekillerinin oturduğu ahşap sıralar, dönemin Ankara Erkek Muallim Mektebi'nden (Öğretmen Okulu) getirtildi.", "Elektriğin olmadığı ilk günlerde meclis çalışmaları, kahvehanelerden toplanan gaz lambaları ile aydınlatılarak yapıldı."] },
  ...
  { lat: 39.9390, lng: 32.8550, type: "müze", name: "Ankara Etnografya Müzesi", desc: "1930 açılış, Türk-İslam halk kültürü. 1938-53 Atatürk'ün geçici kabri.", era: ["selcuklu", "osmanli", "cumhuriyet"], longDesc: "Cumhuriyet döneminde doğrudan müze işleviyle projelendirilip inşa edilen ilk devlet yapısıdır. Namazgâh Tepesi'nde Mimar Arif Hikmet Koyunoğlu tarafından tasarlanan binanın inşasına 1925'te başlanmış, 1930'da ziyarete açılmıştır. Cephesindeki mermer oymacılığı, çini süslemeleri ve görkemli taç kapısıyla Selçuklu-Osmanlı ögelerini Cumhuriyet'in modern vizyonuyla harmanlar.\n\nKoleksiyon, Anadolu'nun Türk-İslam birikimini yansıtır: 13. yüzyıl Ahi Şerafeddin Sandukası, Taşkın Paşa Camii Minberi ve Siirt Ulu Camii Minberi gibi ahşap oyma şaheserleri, Uşak-Bergama halıları, geleneksel kıyafetler ve hat örnekleri eşsiz envanterini oluşturur. Atatürk'ün naaşı, 1938-1953 arasında müzenin iç avlusundaki Muvakkat Kabir'de muhafaza edilmiştir.", funFacts: ["Atatürk'ün naaşı 15 yıl boyunca bu müzenin iç avlusunda kaldı — bina, Anıtkabir tamamlanana kadar geçici \"Anıtkabir\" işlevi gördü.", "Müze önündeki atlı bronz Atatürk heykeli, 1927'de ünlü İtalyan heykeltıraş Pietro Canonica tarafından yapıldı.", "Ankara'da iyi mermer ustası bulunamayınca, Mimar Arif Hikmet Koyunoğlu mermer işçiliğini gençlere bizzat öğreterek uygulattı."] },
  ...
  { lat: 39.9370, lng: 32.8640, type: "müze", name: "Erimtan Arkeoloji ve Sanat Müzesi", desc: "2015 açılış, Roma dönemi cam ve gem koleksiyonu. Salı Konserleri.", era: ["roma", "cumhuriyet"], longDesc: "Ankara Kalesi'nin girişinde, tarihi dokuya saygılı yenilikçi bir mimariyle 2015'te açılan çağdaş bir özel müzedir. Mimarlar Ayşen Savaş, Can Aker ve Onur Yüncü'nün tasarımı; dışarıdan geleneksel üç Ankara evinin cephesini sunarken, içeride brüt betonun öne çıktığı modern bir müzecilik mekânı barındırır.\n\nKurucusu Yüksel Erimtan'ın yarım asrı aşkın sürede topladığı iki bini aşkın eser, ağırlıklı olarak Roma dönemine odaklanır: antik camlar, altın takılar, sikkeler ve mühür yüzük taşları (gemler) \"ticaret\", \"güzellik\", \"mitoloji\" ve \"ölüm ritüelleri\" gibi tematik başlıklar altında sergilenir. Bir Ankara klasiği haline gelen \"Salı Konserleri\" ve çağdaş sanat sergileriyle başkentin entelektüel buluşma noktalarından biridir.", funFacts: ["Roma dönemi cam eserleri ve yüzük taşları (gemler) koleksiyonu, dünyanın en seçkin özel seçkilerinden biri.", "Dışarıdan klasik cumbalı evler gibi görünen yapı, içeride sütunsuz ve yekpare ultra modern bir \"kara kutu\" tasarımı barındırıyor.", "Sergileme vitrinleri, objelerin üzerindeki gölgeleri en aza indirecek özel fiber optik aydınlatma teknolojisiyle donatıldı."] },
  ...
  { lat: 39.9415, lng: 32.8535, type: "müze", name: "PTT Pul Müzesi", desc: "Clemens Holzmeister tasarımı binada filateli ve haberleşme tarihi.", era: "cumhuriyet", image: "https://sgabkrzzzszfqrtgkord.supabase.co/storage/v1/object/public/article-images/harita/ptt-pul-muzesi.png", longDesc: "Dünyaca ünlü Avusturyalı mimar Clemens Holzmeister tarafından tasarlanan bu yapı, 1926'da savaş yetimlerinin eğitimi için Millet Mektepleri olarak inşa edilmiş, daha sonra Ankara Sanat Enstitüsü olarak hizmet vermiştir. Günümüzde beş kata yayılan modern teşhir alanında 4.404 farklı ülkeye ait pullar sergilenmektedir.\n\nKoleksiyonun en değerli parçaları arasında 1840 tarihli İngiliz \"Penny Black\" — dünyanın ilk yapışkanlı posta pulu — ve Osmanlı İmparatorluğu'nun 1863 tarihli ilk pulları yer alır. Dokunmatik ekranlar, artırılmış gerçeklik teknolojileri ve \"Kendi pulunu tasarla\" atölyesiyle müze, klasik sergileme anlayışını aşan interaktif bir deneyim sunar.", funFacts: ["Dünyanın ilk yapışkanlı posta pulu olan 1840 tarihli İngiliz \"Penny Black\" burada sergileniyor — üzerinde Kraliçe Victoria'nın profili var.", "Bina, Clemens Holzmeister tarafından 1926'da savaş yetimlerinin eğitimi için tasarlandı; aynı mimar TBMM binasının da mimarıdır.", "4.404 farklı ülkeye ait pul koleksiyonuyla dünyanın en kapsamlı filateli arşivlerinden biri."] },
  ...
  { lat: 39.8947, lng: 32.8610, type: "müze", name: "Pembe Köşk (İsmet İnönü Müze Evi)", desc: "2. Cumhurbaşkanı'nın 50 yıl yaşadığı ev, Cumhuriyet'in gayriresmi karargâhı.", era: "cumhuriyet", longDesc: "Ankara'nın Çankaya ilçesindeki Pembe Köşk, başkente özgü sivil mimarinin en eski ve karakteristik bağ evi örneklerinden biridir. 1923'te İsmet İnönü tarafından satın alınan ve Mimar Vedat Tek'in tasarımlarıyla genişletilen yapı, 1973'e kadar İnönü ailesinin evi olmuştur. Adını dış cephesindeki yöreye özgü solmayan \"aşı boyası\"nın renginden alır.\n\nErken Cumhuriyet döneminde devletin gayriresmi karargâhı işlevi gören köşk, Ankara'nın ilk balolarına, ilk satranç ve bilardo karşılaşmalarına, ilk klasik müzik dinletilerine ev sahipliği yaparak genç Türkiye'nin Batılılaşma vizyonunun vitrini olmuştur. Günümüzde İnönü Vakfı tarafından müze-ev konseptiyle yaşatılan yapıda orijinal mobilyalar, diplomatik hediyeler, Atatürk ile yazışmalar ve madalyalar sergilenmektedir.", funFacts: ["Müze sürekli açık değil — her yıl yalnızca 23 Nisan ve 29 Ekim haftalarını içeren iki dönemde yaklaşık birer aylığına ziyarete açılıyor.", "Ankara'nın başkent olmasının ardından düzenlenen ilk modern Cumhuriyet Balosu, 22 Şubat 1927'de bizzat Atatürk'ün katılımıyla bu köşkte verildi.", "Atatürk'ün İnönü ile saatlerce memleket meselelerini konuştuğu bilardo odası ve Paris'ten getirtilen orijinal bilardo masası aynen korunuyor."] },
  ...
  { lat: 39.9360, lng: 32.8610, type: "müze", name: "Somut Olmayan Kültürel Miras Müzesi", desc: "Karagöz, meddahlık, ebru. Türkiye'nin ilk SOKÜM müzesi.", era: ["osmanli", "cumhuriyet"], longDesc: "UNESCO'nun 2003 Somut Olmayan Kültürel Mirasın Korunması Sözleşmesi'nden ilham alan müze, Türkiye'nin bu alanda kurulmuş ilk ve öncü kurumudur. Geleneksel bir Ankara evinde faaliyet gösteren müze, UNESCO'nun belirlediği beş temel alan etrafında şekillenmiştir: sözlü gelenekler, gösteri sanatları, toplumsal uygulamalar, doğa bilgisi ve el sanatları.\n\nNinnilerden manilere, Karagöz ve meddahlıktan ebru sanatına uzanan geniş bir kültürel yelpaze, usta anlatıcılar eşliğinde ziyaretçilere aktarılır. Binanın mimari detayları — kadınların erkek misafirleri görünmeden izleyebildiği gözetleme penceresi, modern buzdolabının atası tel dolap — serginin organik bir parçasını oluşturur.", funFacts: ["Kadınlar, erkek misafirleri görmeden izleyebildikleri \"gözetleme penceresi\" sayesinde ev içi mahremiyetlerini korurdu — bu pencere müzede hâlâ yerinde duruyor.", "Modern buzdolabının Anadolu'daki atası \"tel dolap\" burada sergileniyor: sinek girmesini engelleyen sık dokulu telli kapaklar, yiyeceklerin havalanmasını sağlıyordu.", "Türkiye'nin ilk Somut Olmayan Kültürel Miras Müzesi — UNESCO'nun beş temel miras alanının tamamını tek çatı altında sunuyor."] },
  { lat: 40.1709, lng: 31.9178, type: "müze", name: "Beypazarı Yaşayan Müze", desc: "Türkiye'nin ilk uygulamalı kültür müzesi, Geç Osmanlı konağında yaşayan deneyim.", era: "osmanli", longDesc: "23 Nisan 2007'de eğitimci ve halk bilimci Dr. Sema Demir tarafından kurulan Beypazarı Yaşayan Müze, Türkiye'nin ilk uygulamalı kültür müzesidir. Geç Osmanlı dönemi sivil mimarisinin zarif bir örneği olan tarihi konakta faaliyet gösteren müze, statik müzecilik anlayışını kökten değiştiren \"Yeni Müzecilik\" akımının Türkiye'deki öncüsüdür.\n\nKlasik müzelerin aksine bilgi, usta-çırak ilişkisi ve bizzat deneyim yoluyla aktarılır: ziyaretçiler kilim dokur, keçe yapar, hat sanatını dener, yöresel yemekleri hazırlar. Binanın kendisi — ahşap tavanları, cumbalı odaları ve sedirleriyle — serginin ayrılmaz bir parçasıdır.", funFacts: ["Türkiye'nin ilk uygulamalı kültür müzesi — ziyaretçiler kilim dokur, keçe yapar, hat sanatını dener.", "Kurucu Dr. Sema Demir'in vizyonuyla, dünyada yaygınlaşan \"Yeni Müzecilik\" akımının Türkiye'deki öncüsü oldu.", "Bina, Geç Osmanlı dönemine ait ahşap tavan işçiliği, cumbalı odaları ve sedirleriyle serginin canlı bir parçası."] },
  { lat: 40.1685, lng: 31.9195, type: "müze", name: "Türk Hamam Müzesi", desc: "Türkiye'nin ilk hamam müzesi. Selçuklu'dan Osmanlı'ya yıkanma kültürü.", era: ["selcuklu", "osmanli"], longDesc: "Beypazarı'nda yer alan ve Türkiye'nin ilk hamam müzesi unvanını taşıyan bu kurum, Selçuklu'dan Osmanlı'ya uzanan yıkanma ve arınma kültürünü yaşatan özgün bir mekândır. Müzenin barındığı tarihi yapı, 16. yüzyılda Kanuni Sultan Süleyman döneminde Sadrazam Rüstem Paşa tarafından yaptırılan 32 hamamdan biri olan Paşa Hamamı'dır.\n\nYüzyıllar boyunca Beypazarı halkına hizmet eden yapı, 20. yüzyılda işlevini yitirdikten sonra başarılı bir yeniden işlevlendirme projesiyle hamam kültürünü anlatan bir müzeye dönüştürülmüştür. Yaşayan Müze'nin birikimiyle hayata geçirilen proje, binanın orijinal ruhuyla yeni işlevi arasında mükemmel bir uyum sağlar.", funFacts: ["Bina, 1500'lerde Kanuni Sultan Süleyman'ın sadrazamı Rüstem Paşa'nın yaptırdığı 32 hamamdan biridir.", "Türkiye'nin ilk ve tek hamam müzesi — hamam kültürünü bizzat tarihi bir hamam binasında anlatır.", "Yaşayan Müze'nin sosyal sorumluluk projesi olarak doğmuş, yerel inisiyatifle hayata geçirilmiştir."] },
  ...
  { lat: 39.9433, lng: 32.8562, type: "tarihi", name: "Julianus Sütunu", desc: "MS 362, 15m korint başlıklı Roma sütunu.", era: "roma", image: "https://sgabkrzzzszfqrtgkord.supabase.co/storage/v1/object/public/article-images/harita/julianus-sutunu.png", longDesc: "Ankara'nın Roma dönemine ait en önemli anıtsal yapısı, MS 362'de İmparator Julianus'un Pers seferine çıkarken Ankara'yı ziyareti anısına dikilmiştir. Ulus semtinde yükselen 15 metrelik sütun, andezit bir kaide üzerine oturtulmuş beyaz-gri kireç taşı bloklardan oluşur; tepesinde akantus yapraklı Korint başlığı yer alır.\n\nYüzyıllar boyunca halk, orijinal bağlamı unutarak başlıktaki zarif bitkisel motifleri kadınsı bir güzellikle ilişkilendirmiş ve sütuna \"Belkıs Minaresi\" adını vermiştir. Her ilkbahar göç mevsiminde tepesine yuva kuran leylekler, anıtı canlı bir kentsel simgeye dönüştürmüş; ancak Ankara'nın hızlı kentleşmesiyle birlikte bu gelenek son bulmuştur.", funFacts: ["Halk yüzyıllarca Korint başlığındaki zarif yaprak motiflerini kadınsı güzelliğe benzeterek sütuna \"Belkıs Minaresi\" adını taktı — Belkıs, Kur'an'da da anılan Saba Melikesi.", "Leylekler her ilkbahar tepesine yuva kurardı; Ankara'nın hızlı kentleşmesi bu geleneği sona erdirdi.", "Uzaktan yekpare görünse de sütun aslında ustalıkla kesilmiş, yivli ve halka biçiminde üst üste bindirilmiş çok sayıda taş bloktan oluşur."] },
  ...
  /* ── EK MÜZELER ── */
  { lat: 39.9350, lng: 32.8500, type: "müze", name: "Ankara Palas Müzesi", desc: "1928 yapımı Cumhuriyet konukevi, Şubat 2024'te müzeye dönüştürüldü.", era: "cumhuriyet", longDesc: "Ulus'ta II. TBMM binasının karşısında yer alan Ankara Palas, Cumhuriyet'in ilanından sonra yabancı diplomatları ağırlamak üzere 1924'te Mimar Vedat Tek'in tasarımıyla başlanmış, Mimar Kemaleddin tarafından devralınarak 1928'de tamamlanmıştır. Birinci Ulusal Mimarlık Akımı'nın şaheserlerinden olan yapı, çini panoları ve anıtsal kubbeleriyle Türk-İslam mimarisini Batılı vizyonla harmanlar.\n\nAtatürk'ün katıldığı efsanevi Cumhuriyet Baloları bu balo salonunda gerçekleşmiş, İran Şahı'ndan Afgan Kralı'na pek çok dünya lideri burada ağırlanmıştır. Uzun yıllar Dışişleri Bakanlığı konukevi olarak hizmet veren yapı, kapsamlı restorasyon ardından 21 Şubat 2024'te müze olarak açılmıştır. Hereke halıları, Yıldız porselenleri, gümüş sofra takımları ve Cumhuriyet'in ilk yıllarına ait diplomatik eşyalar sergilenmektedir.", funFacts: ["Baş mimar Kemaleddin Bey — günümüzde 20 TL banknotunun arka yüzünde portresi bulunan mimar — şantiyede kaldığı odada beyin kanaması geçirerek hayatını kaybetti.", "Kadınların sosyal hayata erkeklerle eşit katılımını simgeleyen en büyük \"Cumhuriyet Baloları\" bu balo salonunda yapıldı.", "Neredeyse bir asır boyunca yalnızca yabancı devlet protokolüne hizmet veren yapı, 2024'te tarihinde ilk defa vatandaşların ziyaretine açıldı."] },
