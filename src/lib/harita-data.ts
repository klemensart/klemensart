...
export const PLACES: CulturePlace[] = [
  ...
  { lat: 39.8895, lng: 32.8649, type: "müze", name: "Çankaya Köşkü (Atatürk Müze Köşkü)", desc: "1921-1932 Atatürk'ün ikameti, devrimlerin planlandığı yer.", era: "cumhuriyet" },
  ...
  /* ── GALERİLER ── */
  { lat: 39.9400, lng: 32.8530, type: "galeri", name: "Ankara Devlet Resim ve Heykel Müzesi", desc: "1927, Osman Hamdi Bey'den günümüze Türk plastik sanatları.", era: "cumhuriyet" },
  ...
  { lat: 39.9410, lng: 32.8630, type: "tarihi", name: "Hacı Bayram Veli Camii", desc: "1427-28, Augustus Tapınağı bitişiğinde.", era: "osmanli" },
  ...
  /* ── EK TARİHİ ── */
  { lat: 39.9431, lng: 32.8600, type: "tarihi", name: "Antik Roma Tiyatrosu", desc: "MS 1-2. yy, Ankara Kalesi eteklerinde.", era: "roma" },
  { lat: 39.9370, lng: 32.8650, type: "tarihi", name: "Ahi Elvan Camii", desc: "1382, Selçuklu ahşap direkli cami.", era: "selcuklu" },
  ...
  { lat: 39.9350, lng: 32.8540, type: "tarihi", name: "Güven Anıtı ve Güvenpark", desc: "1935, bronz ve taş rölyef kompleksi.", era: "cumhuriyet" },
  { lat: 39.9419, lng: 32.8547, type: "tarihi", name: "Ulus Zafer Anıtı", desc: "1927, Heinrich Krippel, tunç meydan heykeli.", era: "cumhuriyet" },
  ...
  { lat: 39.9400, lng: 32.8550, type: "tarihi", name: "Zincirli Camii", desc: "17. yy, kırmızı tuğla ve ahşap tavan.", era: "osmanli" },
  ...
  { lat: 39.9400, lng: 32.8640, type: "tarihi", name: "Sultan Alaeddin Camii", desc: "1197-98, İç Kale'de surlara yaslanmış. Ahşap tavan ve alçı mihrap ile Selçuklu estetiğinin Ankara'daki en eski temsilcisi.", era: "selcuklu" },
