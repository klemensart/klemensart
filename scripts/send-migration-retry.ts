/**
 * Rate limit'e takılan e-postaları tekrar gönderir.
 * Her istek arasında 600ms bekler.
 */
...
const failedEmails = [
  "mergul8383@gmail.com",
  "ulkercanan.1881@gmail.com",
  "seviltopcu17@gmail.com",
  "sibelkeskin1462@gmail.com",
  "talhaaydin@hotmail.com",
  "kerem.hun@klemensart.com",
  "aydinsevimm@gmail.com",
  "sulebster@gmail.com",
  "sinem_cagla25@hotmail.com",
  "yasavnesli@gmail.com",
  "idilbcr@gmail.com",
  "gozdenurs@gmail.com",
  "gayeocak@gmail.com",
  "nurakgunlu@hotmail.com",
  "zyubeydekorkmaz@gmail.com",
  "sulealcik@hotmail.com",
  "hulya_erman@hotmail.com",
  "beril_baytan@yahoo.com",
  "gozems@yahoo.com",
  "elifgokce_08@hotmail.com",
  "eceaktuna@hotmail.com",
  "cigdem@lokomotifsigorta.com.tr",
  "planzmimarlik@gmail.com",
  "gulsunkizilgun25@gmail.com",
  "esrainal79@gmail.com",
];
...
async function main() {
  ...
  const emailHtml = await render(KlemensNewsletter({ subject, htmlContent }));

  console.log(`${failedEmails.length} başarısız e-posta tekrar gönderiliyor...\n`);

  let sent = 0;
  const errors: string[] = [];

  for (const to of failedEmails) {
    await sleep(600); // rate limit: max 2/sn
  ...
  console.log(`\n═══ Sonuç ═══`);
  console.log(`Zamanlandı: ${sent}/${failedEmails.length}`);
  if (errors.length > 0) {
