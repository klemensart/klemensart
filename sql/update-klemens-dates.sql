...
UPDATE marketplace_events SET event_date = '2026-06-01' WHERE slug = 'ronesans-okuryazarligi-2-klemens';
UPDATE marketplace_events SET event_date = '2026-05-21' WHERE slug = 'kapsamli-sanat-tarihi-klemens';
UPDATE marketplace_events SET event_date = '2026-04-01' WHERE slug = 'leonardo-semineri-klemens';
UPDATE marketplace_events SET event_date = '2026-06-05' WHERE slug = 'sinema-klubu-klemens';
